...
export const lawyers: Lawyer[] = [
  {
    id: "cme30q39o000094uwtvp4iwkc", // John Smith's user ID
    name: "John Smith",
    ...
    experience: 10,
    practiceAreas: ["Corporate Law", "Mergers & Acquisitions", "Contract Law"],
    education: "University of Ghana School of Law, LLB",
    barAssociation: "Ghana Bar Association",
    profileImage: "/lawyers/john-smith.jpg",
    isConnected: false,
    isPending: false,
    connectionCount: 500,
    professionalSummary: "Experienced corporate lawyer with 10+ years in mergers and acquisitions.",
    publications: ["Understanding Corporate Governance in Ghana", "Contract Law Basics"],
    calendlyLink: "https://calendly.com/john-smith/30min",
    email: "john.smith@lawyer.com",
    phone: "+233 24 123 4567",
    website: "www.smithlaw.com",
    detailedBio: "John Smith is a highly experienced corporate lawyer with over 10 years of practice in Ghana. He specializes in corporate governance, mergers and acquisitions, and commercial litigation. He has advised numerous multinational corporations and local businesses on complex legal matters.",
    specializations: ["Corporate Governance", "Securities Law"],
    awards: ["Ghana Law Awards - Corporate Lawyer of the Year 2022", "Outstanding Legal Practitioner 2021"],
    languages: ["English", "Twi"]
  },
  {
    id: "cme30q39v000194uwvwcttzf2", // Sarah Johnson's user ID
    name: "Sarah Johnson",
    title: "Legal Practitioner",
    firm: "Johnson Family Law Practice",
    location: "Kumasi, Ghana",
    barAdmissionYear: 2016,
    experience: 8,
    practiceAreas: ["Family Law", "Child Custody", "Adoption"],
    education: "KNUST Faculty of Law, LLB",
    barAssociation: "Ghana Bar Association",
    profileImage: "/lawyers/sarah-johnson.jpg",
    isConnected: true,
    isPending: false,
    connectionCount: 342,
    professionalSummary: "Family law specialist focusing on divorce, custody, and adoption cases.",
    publications: ["Family Rights in Ghana: A Guide"],
    calendlyLink: "https://calendly.com/sarah-johnson/consultation",
    email: "sarah.johnson@lawyer.com",
    phone: "+233 20 987 6543",
    detailedBio: "Sarah Johnson has dedicated her career to family law in Ghana. She has successfully handled over 200 family cases and adoption procedures, making her one of the most sought-after family lawyers in the Ashanti region.",
  ...
  {
    id: "cme30q39y000294uw9bbje3xp", // Michael Brown's user ID
    name: "Michael Brown",
    title: "Criminal Defense Attorney",
    firm: "Brown Criminal Defense",
    location: "Takoradi, Ghana",
    barAdmissionYear: 2012,
    experience: 12,
    practiceAreas: ["Criminal Law", "White Collar Crime", "Appeals"],
    education: "University of Cape Coast Faculty of Law, LLB",
    barAssociation: "Ghana Bar Association",
    profileImage: "/lawyers/michael-brown.jpg",
    isConnected: false,
    isPending: true,
    connectionCount: 278,
    professionalSummary: "Criminal defense attorney with expertise in white-collar crimes.",
    publications: ["Criminal Law in Ghana: Know Your Rights"],
    calendlyLink: "https://calendly.com/michael-brown/criminal-defense",
    email: "michael.brown@lawyer.com",
    phone: "+233 31 456 7890",
    detailedBio: "Michael Brown is an experienced criminal defense attorney who has helped hundreds of clients navigate complex criminal cases. He specializes in white-collar crimes, financial crimes, and appeals court representation.",
    specializations: ["Financial Crimes", "Appeals Court"],
    awards: ["Criminal Defense Excellence Award 2021"],
