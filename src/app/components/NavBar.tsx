    ...
    <div>
      ...
      >
        ...
        >
          {/* Progress Bar */}
          <motion.div
            className="absolute top-0 left-0 h-[2px] bg-gradient-to-r bg-[#b98a11]"
            style={{
              width: "100%",
          ...
          <div className="flex justify-between items-center">
            ...
            >
              <Link href="/" className="flex items-center gap-3">
                ...
                >
                  <Scale className="w-8 h-8 text-[#b98a11]" />
                </motion.div>
                <span className="text-xl font-bold bg-gradient-to-r bg-[#b98a11] bg-clip-text text-transparent">
                  LegalConnect
                </span>
              </Link>
            </motion.div>
